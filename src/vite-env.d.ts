...
interface ImportMetaEnv {
  ...
  readonly VITE_PANEL_LINKEDIN_STATUS_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_CONNECT_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_EXCHANGE_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_VALIDATE_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_CONNECTION_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_AD_ACCOUNTS_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_SOCIAL_MEDIA_ACCOUNTS_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_SOCIAL_MEDIA_DASHBOARD_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_SOCIAL_MEDIA_CONTENTS_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_DASHBOARD_SUMMARY_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_DASHBOARD_TIMELINE_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_DASHBOARD_FUNNEL_PATH?: string;
  readonly VITE_PANEL_LINKEDIN_DASHBOARD_TABLE_PATH?: string;
