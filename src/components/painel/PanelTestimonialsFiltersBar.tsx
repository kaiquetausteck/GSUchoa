...
import type { PanelTestimonialSort } from "../../services/painel/testimonials-api";
import { AppInput } from "../shared/ui/AppInput";
import { AppSelect } from "../shared/ui/AppSelect";

type PanelTestimonialsFiltersBarProps = {
  ...
  onSortChange: (value: PanelTestimonialSort) => void;
  perPage: number;
  publishedValue: "all" | "published" | "draft";
  searchValue: string;
  sortValue: PanelTestimonialSort;
};
...
export function PanelTestimonialsFiltersBar({
  ...
  searchValue,
  sortValue,
}: PanelTestimonialsFiltersBarProps) {
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div className="min-w-0 flex-1">
          <AppInput
            ...
            placeholder="Buscar por marca, autor ou cargo"
            value={searchValue}
