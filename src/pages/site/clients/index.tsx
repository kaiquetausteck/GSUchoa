        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl font-black leading-none tracking-tight md:text-7xl">
              Marcas atendidas com prova social organizada em <span className="text-gradient">vitrine viva.</span>
            </h1>
            <p className="mt-8 max-w-3xl text-lg leading-relaxed text-on-surface-variant md:text-xl">
              Uma camada publica para navegar pelas marcas que confiam na GSUCHOA e entender como essa parceria aparece na nossa presenca digital.
            </p>
          </div>
